"""THIS IS A REALLY REALLY SLOW CODE WE NEEDED TO INPUT SOME DELAY FOR EVERY HTTP REQUEST
    BECAUSE THE BROWERS WE ARE SCRAPING DATA FROM HAS A RATE LIMIT.
    SEE MORE INFO HERE: https://dblp.uni-trier.de/faq/1474706.html """

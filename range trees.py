...
values = []
surname_tree = RangeTree('surname')
awards_tree = RangeTree('awards')
dblp_tree = RangeTree('dblp_record')

for scientist_data in data:
    features = get_features(scientist_data)
    values.append(features)
    surname_tree.insert(scientist_data)
    awards_tree.insert(scientist_data)
    dblp_tree.insert(scientist_data)
